...
<section class="xs-banner-inner-section parallax-window" style="background-image:url('assets/images/gallery_bg.jpg'); padding-bottom: 140px; padding-top: 100px;">
					...
					<div class="xs-contact-form-wraper login-form-div">
						<form action="#" method="POST" id="xs-contact-form" class="signup-form xs-contact-form contact-form-v2">
							...
							<div class="text-center mt-4">
								<article class="text-light">Already a member ? <a class="signup-text" href="login.php"> Sign In</a></article>
							</div>
