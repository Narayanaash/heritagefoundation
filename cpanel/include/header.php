...
<div class="xs-top-bar top-bar-second">
	<div class="container clearfix">
		...
		<a href="mailto:name@domain.com" class="xs-top-bar-mail"><i class="fa fa-envelope-o"></i>info@example.com</a>
	</div>
</div>
					...
					<ul class="nav-menu">
						...
						<li><a href="#">More</a>
							<ul class="nav-dropdown">
								...
								<li><a href="tribes.php">Tribes of NE</a></li>
								<li><a href="folktales.php">Folk Tales</a></li>
							</ul>
						</li>
