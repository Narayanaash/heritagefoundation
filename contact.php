...
<section class="xs-banner-inner-section contactus_breadcumb parallax-window" style="background-image:url('assets/images/contact/bg.jpg')">
		...
		<div class="row">
			...
			<div class="col-md-6 col-lg-4">
				<div class="xs-contact-details">
					...
					<!-- xs-widnow-wraper -->
					<ul class="xs-unorder-list">
						<li><i class="fa fa-map-marker color-green"></i>Protus Thom, Prekunak, India</li>
					</ul>
				</div>
				<!-- xs-contact-details -->
			</div>
